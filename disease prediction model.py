...
tr=pd.read_csv("D:\SEM 5 Submissions\data mining\\testing.csv")
...
df=pd.read_csv("D:\SEM 5 Submissions\data mining\\training.csv")
DF= pd.read_csv('D:\SEM 5 Submissions\data mining\\training.csv', index_col='prognosis')
...
def message():
    if (Symptom1.get() == "None" and  Symptom2.get() == "None" and Symptom3.get() == "None" and Symptom4.get() == "None" and Symptom5.get() == "None"):
        messagebox.showinfo("PLEASE ENTER SYMPTOMS")
    else :
        KNN()
...
w2 = Label(root, justify=LEFT, text=" Disease Prediction Project ")
w2.config(font=("Times", 30))
w2.config(bg='#D9D8D7')
